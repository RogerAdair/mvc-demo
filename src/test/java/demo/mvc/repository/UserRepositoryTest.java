    ...
    public void setUp() throws Exception {
        ...
        for (int i = 0; i < 20; i++) {
         //   DateTime birth = new DateTime().withDate(1990 + i, i % 12 + 1,
          //          i % 30 + 1);
            Object[] arg = new Object[] { "name" + i,90+i%10,
                    "password" + i, now.toDate(), now.toDate(), 1 };
            args.add(arg);
        }
        jdbcTemplate
                .batchUpdate(
                        "INSERT INTO T_USER(USER_NAME, USER_SCORE, USER_PASSWORD, CREATED_AT, UPDATED_AT, VERSION) VALUES(?,?,?,?,?,?)",
                        args);
    }
...
//        user.setBirth(new Date());
        ...
        assertThat((Integer) result.get("USER_SCORE"), is(0));
